...
namespace JfYu.Office.Excel
{
    ...
    public interface IJfYuExcel
    {
        ...
        (List<T1>, List<T2>) Read<T1, T2>(Stream stream, int firstRow = 1, int sheetIndex = 0) where T1 : class where T2 : class;
        ...
        /// <typeparam name="T2">The second class type to convert the data to.</typeparam>
        /// <param name="filePath">The file path of the Excel file.</param>
        /// <param name="firstRow">The first row to start reading from (default is 1).</typeparam>
        /// <param name="sheetIndex">The index of the sheet to read from (default is 0).</param>
        /// <returns>A tuple containing two Lists populated from the sheet.</returns>
        /// <exception cref="FileNotFoundException">Thrown when the file is not found.</exception>
        (List<T1>, List<T2>) Read<T1, T2>(string filePath, int firstRow = 1, int sheetIndex = 0) where T1 : class where T2 : class;
        ...
        /// <param name="stream">The file stream to read from.</typeparam>
        /// <param name="firstRow">The first row to start reading from (default is 1).</param>
        /// <param name="sheetIndex">The index of the sheet to read from (default is 0).</param>
        /// <returns>A tuple containing three Lists populated from the sheet.</returns>
        (List<T1>, List<T2>, List<T3>) Read<T1, T2, T3>(Stream stream, int firstRow = 1, int sheetIndex = 0) where T1 : class where T2 : class where T3 : class;
        ...
        /// <returns>A tuple containing three Lists populated from the sheet.</returns>
        /// <exception cref="FileNotFoundException">Thrown when the file is not found.</exception>
        (List<T1>, List<T2>, List<T3>) Read<T1, T2, T3>(string filePath, int firstRow = 1, int sheetIndex = 0) where T1 : class where T2 : class where T3 : class;
        ...
        (List<T1>, List<T2>, List<T3>, List<T4>) Read<T1, T2, T3, T4>(Stream stream, int firstRow = 1, int sheetIndex = 0) where T1 : class where T2 : class where T3 : class where T4 : class;
        ...
        /// <returns>A tuple containing four Lists populated from the sheet.</returns>
        /// <exception cref="FileNotFoundException">Thrown when the file is not found.</exception>
        (List<T1>, List<T2>, List<T3>, List<T4>) Read<T1, T2, T3, T4>(string filePath, int firstRow = 1, int sheetIndex = 0) where T1 : class where T2 : class where T3 : class where T4 : class;
        ...
        (List<T1>, List<T2>, List<T3>, List<T4>, List<T5>) Read<T1, T2, T3, T4, T5>(Stream stream, int firstRow = 1, int sheetIndex = 0) where T1 : class where T2 : class where T3 : class where T4 : class where T5 : class;
        ...
        /// <returns>A tuple containing five Lists populated from the sheet.</returns>
        /// <exception cref="FileNotFoundException">Thrown when the file is not found.</exception>
        (List<T1>, List<T2>, List<T3>, List<T4>, List<T5>) Read<T1, T2, T3, T4, T5>(string filePath, int firstRow = 1, int sheetIndex = 0) where T1 : class where T2 : class where T3 : class where T4 : class where T5 : class;
        ...
        (List<T1>, List<T2>, List<T3>, List<T4>, List<T5>, List<T6>) Read<T1, T2, T3, T4, T5, T6>(Stream stream, int firstRow = 1, int sheetIndex = 0) where T1 : class where T2 : class where T3 : class where T4 : class where T5 : class where T6 : class;
        ...
        /// <returns>A tuple containing six Lists populated from the sheet.</returns>
        /// <exception cref="FileNotFoundException">Thrown when the file is not found.</exception>
        (List<T1>, List<T2>, List<T3>, List<T4>, List<T5>, List<T6>) Read<T1, T2, T3, T4, T5, T6>(string filePath, int firstRow = 1, int sheetIndex = 0) where T1 : class where T2 : class where T3 : class where T4 : class where T5 : class where T6 : class;
        ...
        (List<T1>, List<T2>, List<T3>, List<T4>, List<T5>, List<T6>, List<T7>) Read<T1, T2, T3, T4, T5, T6, T7>(Stream stream, int firstRow = 1, int sheetIndex = 0) where T1 : class where T2 : class where T3 : class where T4 : class where T5 : class where T6 : class where T7 : class;
        ...
        /// <returns>A tuple containing seven Lists populated from the sheet.</returns>
        /// <exception cref="FileNotFoundException">Thrown when the file is not found.</exception>
        (List<T1>, List<T2>, List<T3>, List<T4>, List<T5>, List<T6>, List<T7>) Read<T1, T2, T3, T4, T5, T6, T7>(string filePath, int firstRow = 1, int sheetIndex = 0) where T1 : class where T2 : class where T3 : class where T4 : class where T5 : class where T6 : class where T7 : class;
